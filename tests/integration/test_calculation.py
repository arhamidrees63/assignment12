...
# --------------------------------------------------------------------------
# Extra lightweight coverage helper for app.main
# --------------------------------------------------------------------------
def test_app_health_and_metadata():
    """
    This lightweight test simply imports app.main and verifies
    that the /health endpoint returns {'status': 'ok'}.
    It increases coverage for app.main without side effects.
    """
